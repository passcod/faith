...
set output 'charts/throughput_parallelism_cloudflare_zero.png'
set title 'Throughput by Parallelism: Cloudflare Target (100 requests) (higher is better) (Y-axis from zero)'
...
plot 'charts/throughput_parallelism_cloudflare_data.txt' using 2:xtic(1) title 'native', \
