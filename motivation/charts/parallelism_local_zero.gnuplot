...
set output 'charts/parallelism_local_zero.png'
set title 'Parallelism Impact: Local Target (100 requests) (lower is better) (Y-axis from zero)'
...
plot 'charts/parallelism_local_data.txt' using 2:xtic(1) title 'native', \
