...
set output 'charts/performance_local_zero.png'
set title 'Performance Comparison (Local Target) (lower is better) (Y-axis from zero)'
...
plot 'charts/performance_local_data.txt' using 2:xtic(1) title 'native', \
