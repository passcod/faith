...
set output 'charts/throughput_local_zero.png'
set title 'Throughput: Requests per Second (Local Target) (higher is better) (Y-axis from zero)'
...
plot 'charts/throughput_local_data.txt' using 2:xtic(1) title 'native', \
