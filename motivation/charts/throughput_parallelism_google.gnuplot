...
set output 'charts/throughput_parallelism_google.png'
set title 'Throughput by Parallelism: Google Target (100 requests) (higher is better)'
...
plot 'charts/throughput_parallelism_google_data.txt' using 2:xtic(1) title 'native', \
