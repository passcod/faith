...
set output 'charts/performance_google_zero.png'
set title 'Performance Comparison (Google Target - TCP) (lower is better) (Y-axis from zero)'
...
plot 'charts/performance_google_data.txt' using 2:xtic(1) title 'native', \
