...
set output 'charts/parallelism_cloudflare.png'
set title 'Parallelism Impact: Cloudflare Target (100 requests) (lower is better)'
...
plot 'charts/parallelism_cloudflare_data.txt' using 2:xtic(1) title 'native', \
