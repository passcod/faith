...
set output 'charts/throughput_parallelism_local_zero.png'
set title 'Throughput by Parallelism: Local Target (100 requests) (higher is better) (Y-axis from zero)'
