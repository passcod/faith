...
## Populate the request-writing timestamps · F2
...
## Populate the DNS, connect, and TLS phases · G2
...
## Populate the redirect phases · H2
...
## Populate the interim response timestamp · J2
...
## Populate the transfer and body sizes · K2
