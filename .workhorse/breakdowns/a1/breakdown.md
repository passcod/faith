...
## Back off the HTTP/3 broken cooldown exponentially
...
## Add preconnect() and prefetchDns() agent APIs
...
## Add a network-change signal API
...
## Serve stale cache entries per RFC 5861
...
## Expose a per-request timing breakdown
...
## Investigate BBRv3 congestion control
...
## Expose a Rust API and publish to crates.io
